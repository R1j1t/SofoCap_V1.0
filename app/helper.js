...
var getOrgName1=function (org) {
	return ORGS[org].name;
}

var getRegisteredUsers = function(username, userOrg, isJson,Secret) {
	var member;
	var client = getClientForOrg(userOrg);
	var enrollmentSecret = null;
	console.log('==================KEY VALUE STORE FOR ORG1===============');
...
exports.getOrgName=getOrgName1
