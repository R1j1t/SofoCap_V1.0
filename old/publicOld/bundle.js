...
},{"./core/qrcode":18,"./renderer/canvas":24,"./renderer/svg-render.js":25}],3:[function(require,module,exports){
/**
...
},{"../utils/buffer":27}],7:[function(require,module,exports){
var Buffer = require('../utils/buffer')
var Mode = require('./mode')
...
},{"../utils/buffer":27,"./mode":15}],8:[function(require,module,exports){
...
},{"../utils/buffer":27}],13:[function(require,module,exports){
var Mode = require('./mode')
var Utils = require('./utils')
...
},{"./regex":20,"./version":23}],16:[function(require,module,exports){
var Mode = require('./mode')
...
},{"../utils/buffer":27,"./galois-field":12}],18:[function(require,module,exports){
var Buffer = require('../utils/buffer')
var Utils = require('./utils')
var ECLevel = require('./error-correction-level')
...
},{"../utils/buffer":27,"./alignment-pattern":3,"./bit-buffer":5,"./bit-matrix":6,"./error-correction-code":8,"./error-correction-level":9,"./finder-pattern":10,"./format-info":11,"./mask-pattern":14,"./mode":15,"./reed-solomon-encoder":19,"./segments":21,"./utils":22,"./version":23,"isarray":28}],19:[function(require,module,exports){
var Buffer = require('../utils/buffer')
...
},{"../utils/buffer":27,"./polynomial":17}],20:[function(require,module,exports){
var numeric = '[0-9]+'
...
},{"./error-correction-code":8,"./error-correction-level":9,"./mode":15,"./utils":22,"isarray":28}],24:[function(require,module,exports){
var Utils = require('./utils')
...
document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  var response=document.getElementById(responseStr);
  //do work
  R.toString(inp.value,[{version:1}],function (err, string) {
    if (err) throw err
    response.innerHTML='<html><div class="canvasParent">'+string+"</div></html>";
  })
  }
